...
-- Paso 1: Remover las referencias de foreign key temporalmente
UPDATE restaurants SET specializes_in_diet = NULL WHERE specializes_in_diet IS NOT NULL;

-- Paso 2: Limpiar completamente la tabla diet_types
DELETE FROM diet_types;

-- Paso 3: Insertar las nuevas opciones de dieta con estructura intuitiva
-- Vegetariano
