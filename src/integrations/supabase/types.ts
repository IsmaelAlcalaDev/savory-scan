...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      calculate_restaurant_poi_proximity: {
      ...
      get_popular_dishes: {
        Args: { restaurant_id_param: number; limit_count?: number }
        Returns: {
          dish_id: number
          dish_name: string
          base_price: number
      ...
      recalculate_favorites_counters: {
        Args: Record<PropertyKey, never>
        Returns: undefined
      }
      remove_gallery_image: {
        Args: { p_restaurant_id: number; p_image_url: string }
        Returns: boolean
      }
      search_restaurants: {
        Args: {
      ...
      search_restaurants_by_location: {
        ...
        Returns: {
          ...
          location_tags: Json
          nearby_pois: string[]
          is_in_famous_area: boolean
        }[]
      }
      search_restaurants_with_diet_filters: {
        Args: {
          search_query?: string
          user_lat?: number
          user_lng?: number
        ...
        Returns: {
          ...
          cuisine_types: string[]
          establishment_type: string
          diet_specialized: string
          vegetarian_dishes_count: number
          vegan_dishes_count: number
          gluten_free_dishes_count: number
          lactose_free_dishes_count: number
          healthy_dishes_count: number
        }[]
      }
      toggle_dish_favorite: {
        Args: { user_id_param: string; dish_id_param: number }
        Returns: boolean
      }
      toggle_event_favorite: {
        Args: { user_id_param: string; event_id_param: number }
        Returns: boolean
      }
